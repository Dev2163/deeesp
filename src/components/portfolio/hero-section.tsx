...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex flex-col items-center w-full px-4 md:px-0">
          ...
          <motion.div
            ...
            className="absolute -top-6 sm:-top-8 md:-top-8 z-20"
          >
            <h2 className="font-['Dancing_Script'] text-4xl sm:text-6xl md:text-8xl lg:text-9xl text-[#ffb703] drop-shadow-[0_5px_15px_rgba(0,0,0,0.5)]">
              Creative
            </h2>
          </motion.div>

          {/* Huge PORTFOLIO Text */}
          <div className="overflow-hidden py-4 w-full flex justify-center">
            <motion.h1
              initial={{ y: "100%", opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1], delay: 0.2 }}
              className="font-display font-black text-[12vw] sm:text-[14vw] md:text-[18vw] leading-[0.85] text-center uppercase text-slate-900 dark:text-white drop-shadow-[0_10px_20px_rgba(0,0,0,0.15)] dark:drop-shadow-2xl select-none whitespace-nowrap z-10 tracking-tighter transition-colors duration-500"
            >
              PORTFOLIO
            </motion.h1>
          </div>
      ...
      <div className="absolute bottom-8 md:bottom-12 w-full px-6 md:px-12 flex justify-end items-end z-20">
