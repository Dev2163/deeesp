...
import { Home, Rocket, GraduationCap, User, MessageSquare } from "lucide-react"
...
export function Header() {
    ...
    return (
        <>
            {/* Top screen hover zone to trigger showing the header */}
            <div
                className="fixed top-0 left-0 right-0 h-4 z-[49] pointer-events-auto"
